...
<form id="<?php print($handle); ?>" onsubmit="return createTheme(this.theme.value)" class="box"  onmousedown="boxList.focus(this)" style="max-width:580px">
	...
	<div class="box-footer">
		<button type="submit" data-translate="nodeValue">apply</button>
