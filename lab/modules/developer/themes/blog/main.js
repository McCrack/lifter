...
var Stream = function(default_node){
	...
	stream.bufferization = function(onLoad){
		...
		XHR.push({
			"protect":false,
			"addressee":"/xhr/feed/json/"+Page.published+"/"+stream.seek+"/"+Page.section,
			"onsuccess":onLoad || function(response){
...
function ShowInvite(){
	XHR.push({
		"protect":false,
		"addressee":"/xhr/community/invitebox",
		"onsuccess":function(response){
			var substrate = doc.create("div", response, {id:"substrate"});
