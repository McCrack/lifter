...
<form id="<?php print($handle); ?>" onsubmit="return saveShortWordlist(this)" class="box" onreset="boxList.drop(this.id)" onmousedown="boxList.focus(this)" style="max-width:680px">
