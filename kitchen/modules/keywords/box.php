...
?>
<form id="<?=$handle?>" onsubmit="return boxList[handle].addSection()" class="box" onreset="boxList[boxList.onFocus].drop()" onmousedown="boxList.focus(this)" style="max-width:720px">
