...
<?php
	...
	foreach(scandir("../") as $subdomain){
		if(($subdomain!=".") && ($subdomain!="..") && is_dir("../".$subdomain)){
			$tree .= "<a class='domain' href='/uploader/".$subdomain."'>".$subdomain."</a><div data-root='".$subdomain."'></div>";
		}
	}
	print($tree);
...
foreach(scandir("../") as $dir){
	if(($dir!="." && $dir!="..") && is_dir("../".$dir)){
		$folders .= "<a href='/uploader/".$dir."' class='file-sticker'><figure data-context='folder'><img src='/images/mime/folder.png'>".$dir."</figure></a>";
	}
}
print $folders;
