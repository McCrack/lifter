...
?>
<form id="<?=$handle?>" class="box"  onmousedown="boxList.focus(this)" style="max-width:820px">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<script>
var handle = "<?php print $handle; ?>";
boxList[handle].getHTMLPattern=function(obj){
...
boxList[handle].removePatterns=function(){
	...
	<div class="box-title">
		...
		<span style="color:#C02;">HTML</span>Pattern
	</div>
	<div class="box-body" style="
		...
		<div class="panel" align="left">
			...
			<input name="path" value="patterns/html" placeholder="path" data-translate="placeholder" required readonly style="
				width:454px;
				padding:4px 10px;
				border-radius:3px;
		...
		<div class="leftbar" onclick="boxList[handle].getHTMLPattern(event.target)" style="height:calc(100% - 36px);overflow-y:scroll;padding:15px;box-sizing:border-box;">
		<?=patterns_tree()?>
		</div>
